...
export const promoteSuccess = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: promoteSuccess.url(options),
    method: 'get',
})

promoteSuccess.definition = {
    methods: ["get","head"],
...
promoteSuccess.url = (options?: RouteQueryOptions) => {
    return promoteSuccess.definition.url + queryParams(options)
}
...
const ListingController = { create, edit, show, promote, promoteSuccess, store, update, destroy }
